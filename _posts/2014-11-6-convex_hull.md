...
![an image alt text]({{ site.baseurl }}/images/HELHEIM_04_POINTS.png "Original points")

![an image alt text]({{ site.baseurl }}/images/HELHEIM_04.png "Convex hull point vertices")
